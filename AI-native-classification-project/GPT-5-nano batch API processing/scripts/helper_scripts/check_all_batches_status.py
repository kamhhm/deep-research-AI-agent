#!/usr/bin/env python3
"""
Comprehensive batch status checker for GPT-5-nano
...
print("="*70)
print("COMPREHENSIVE BATCH STATUS CHECK - GPT-5-NANO")
print("="*70)
...
if in_progress_count > 0:
    print("1. Wait for in-progress batches to complete")
if not_uploaded:
    print(f"2. Upload {len(not_uploaded)} batch(es) that are ready")
    print("   Run: python3 MTA_multi_batch_gpt5_nano.py")
